...
L["Failures"] = true
L["Notes: alerts are disabled outside of instances and players flagged as tanks are ignored."] = true
...
L["Notes: alerts are disabled outside of instances and players flagged as tanks are ignored."] = "Notes: les alertes sont désactivées en dehors des instances, et les joueurs marqués comme tank sont ignorés."
